...
// Taken from https://github.com/HHH-Kaboom-Dev/HBot/blob/main/src/main/java/com/github/hhhzzzsss/hbot/util/HashUtils.java
public class HashUtils {
	...
	public static boolean isValidHash(String text, String username, String key, String hash) {
		...
		final String expectedHash = getHash(text + ";" + username + ";" + time + ";" + key);
